    ...
    <ThemeProvider theme={theme}>
      ...
      <Container component="main" maxWidth="md" sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" sx={{ fontSize: '18px', mb: 2 }}>
          في E-SAJ، نحن أكثر من مجرد مستشارين قانونيين؛ نحن شركاؤك في النجاح. ندرك التحديات القانونية التي تواجه الشركات في الأسواق اليوم، ولذلك نلتزم بتقديم حلول قانونية مبتكرة وفعالة تلبي احتياجاتك الخاصة.
        </Typography>
        ...
        <Typography variant="h6" gutterBottom align="center">
          لا تتردد في اتخاذ الخطوة الأولى نحو حماية وتطوير أعمالك. املأ النموذج الآن وابدأ رحلتك مع فريق E-SAJ.
        </Typography>
